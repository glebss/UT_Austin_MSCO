...
class DetectionSuperTuxDataset(Dataset):
    def __init__(self, dataset_path, transform=dense_transforms.ToTensor(), min_size=20, train=False):
    ...
    def __getitem__(self, idx):
        ...
        dets = data[1:]
        img = data[0]
        hm, size = dense_transforms.detections_to_heatmap(dets, img.shape[1:])
        return img, hm.numpy(), size.numpy()
